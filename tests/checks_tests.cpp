...
std::vector<std::array<const Card*, 2>> find_pairs(const CardsByRank& hand);
std::vector<std::array<const Card*, 3>> find_triples(const CardsByRank& hand);
std::vector<std::array<const Card*, 5>> find_flush(
    const CardsBySuit& hand, std::size_t threshold = 5);
std::vector<std::array<const Card*, 5>> is_straight(
    const CardsByRank& hand, std::size_t threshold = 5);
std::vector<std::array<const Card*, 5>> find_full_house(
    const std::vector<std::array<const Card*, 2>>& pairs,
...
void test_four_card_flush() {
    const std::vector<Card> cards = {
        {Suit::HEARTS, CardRank::TWO},
        {Suit::HEARTS, CardRank::FOUR},
        {Suit::HEARTS, CardRank::SIX},
        {Suit::HEARTS, CardRank::EIGHT},
...
void test_five_card_flush() {
    const std::vector<Card> cards = {
        {Suit::SPADES, CardRank::TWO},
        {Suit::SPADES, CardRank::FOUR},
        {Suit::SPADES, CardRank::SIX},
        {Suit::SPADES, CardRank::EIGHT},
...
void test_four_card_straight() {
    ...
    const auto straights = is_straight(group_by_rank(cards), 4);
    ...
    assert(is_straight(group_by_rank(cards), 5).empty());
}

void test_five_card_straight_ending_at_ace() {
    const std::vector<Card> cards = {
        {Suit::HEARTS, CardRank::TEN},
        {Suit::CLUBS, CardRank::JACK},
        {Suit::SPADES, CardRank::QUEEN},
        {Suit::DIAMONDS, CardRank::KING},
        {Suit::HEARTS, CardRank::ACE},
    };

    const auto straights = is_straight(group_by_rank(cards));
...
void test_full_house() {
    ...
    const auto full_houses = find_full_house(find_pairs(hand), find_triples(hand));
